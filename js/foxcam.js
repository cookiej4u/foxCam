...
(function () {
    ...
    $(".fa-crop").click(function(e){
		e.preventDefault();
		$("#edit-intro").css('visibility','hidden');
		$("#edit-crop").css('visibility','visible');
	});
	$(".fa-repeat").click(function(e){
		e.preventDefault();
		$("#edit-intro").css('visibility','hidden');
		$("#edit-rotate").css('visibility','visible');
	});
	$(".fa-magic").click(function(e){
		e.preventDefault();
		$("#edit-intro").css('visibility','hidden');
		$("#edit-effect").css('visibility','visible');
	});
	$(".fa-check").click(function(e){
		e.preventDefault();
		$("#edit-intro").css('visibility','visible');
		$("#edit-crop").css('visibility','hidden');
		$("#edit-rotate").css('visibility','hidden');
		$("#edit-effect").css('visibility','hidden');
	});
